...
const vitaferProducts = [
  ...
  },
  {
    ...
    description: "¡El mejor valor! Equípate con nuestro pack de tres frascos de Vitafer-L y asegura tu máximo rendimiento al mejor precio. 🚀",
    detailedDescription: "Maximiza tu ahorro y tus resultados con el pack de tres Vitafer-L 500mL. Esta es la opción más económica para usuarios regulares que no quieren quedarse sin su dosis de energía diaria. Asegura tu bienestar y rendimiento por meses con una sola compra.",
    ingredients: commonIngredients,
    usageInstructions: "Adultos: Tomar una (1) copa dosificadora (aproximadamente 10mL a 20mL) una (1) vez al día. Para un efecto potenciador, tomar 30-60 minutos antes de la actividad física. Agítese bien antes de usar.",
    benefits: commonBenefits,
    warnings: commonWarnings,
  ...
  },
  {
    ...
    ingredients: commonIngredients,
    usageInstructions: "Adultos: Consumir el contenido completo de un (1) sachet (10mL) directamente o diluido en su bebida favorita, una (1) vez al día o según necesidad. Para un efecto potenciador, tomar un sachet 30-60 minutos antes de la actividad.",
    benefits: commonBenefits,
    warnings: commonWarnings,
  ...
  },
  {
    ...
    ingredients: commonIngredients,
    usageInstructions: "Adultos: Tomar el contenido de un (1) shot (20mL) directamente, una (1) vez al día o según necesidad. Para un efecto potenciador, se sugiere consumir un shot 30-60 minutos antes de la actividad deseada. Agítese antes de consumir.",
    benefits: commonBenefits,
    warnings: commonWarnings,
...
const vitaferOffers = [
  {
    ...
    description: "¡Oferta especial para distribuidores! Llévate 25 botellas del potente Vitafer-L 500mL a un precio increíble y maximiza tus ganancias.",
    detailedDescription: "Este paquete mayorista de Vitafer-L 500mL está pensado para distribuidores y negocios que desean ofrecer a sus clientes un producto de alta demanda. Cada caja contiene 25 frascos de la fórmula clásica de Vitafer-L, ideal para mejorar la energía, vitalidad y el rendimiento general. Aprovecha los precios por volumen.",
    ingredients: commonIngredients,
  ...
  },
  {
    ...
    description: "¡Ideal para eventos o reventa! Adquiere 12 cajas de nuestros potentes Vitafer-L Shots de 20mL y asegura la energía donde la necesites.",
    detailedDescription: "Maximiza tu inventario con este paquete mayorista de Vitafer-L Shots. Recibirás 12 displays, cada uno conteniendo 24 shots individuales de 20mL (un total de 288 shots). Perfectos para reventa individual, para ofrecer en eventos, o para asegurar un suministro prolongado de este potente energizante.",
    ingredients: commonIngredients,
  ...
  },
  {
    ...
    unitDescription: "por paquete de 12 cajas",
    presentation: "Paquete Mayorista: 12 Displays (cada display con 15 sachets de 10mL). Total 180 sachets.",
    description: "¡Ideal para negocios o reventa! Adquiere 12 cajas de nuestros prácticos Vitafer-L Sachets y ofrece energía para llevar.",
    detailedDescription: "Maximiza tu inventario con este paquete mayorista de Vitafer-L en Sachets. Recibirás 12 displays, cada uno con 15 sachets de 10mL (un total de 180 unidades). Perfectos para la reventa individual gracias a su formato práctico y discreto, ideal para clientes que buscan un impulso de energía al instante.",
    ingredients: commonIngredients,
    usageInstructions: "Ver modo de uso del Vitafer-L Sachet 10mL individual. Este paquete es para distribución.",
    benefits: commonBenefits,
    warnings: commonWarnings,
    category: "Mayoreo",
