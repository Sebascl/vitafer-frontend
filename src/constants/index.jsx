...
const vitaferProducts = [
  ...
  },
  {
    ...
    {
    id: "vitafer-l-sachet-x2-promo",
    name: "🔥 Promo: 2 Cajas de Sachets Vitafer-L",
    modelPath: "/images/sachetsx2.png",
    price: "$ 1.500",
    originalPrice: "$ 1.800",
    isPromo: true,
    presentation: "Pack de 3 Cajas de Sobres de 10mL c/u",
    description: "¡El combo perfecto! 2 cajas de potencia portátil con un precio irresistible.",
    detailedDescription: "Disfruta de la libertad y la potencia con este pack de 3 cajas de sachets. Ideal para un fin de semana largo o para tener siempre una reserva a mano. La misma fórmula efectiva en su presentación más práctica, ahora con un descuento especial.",
    ingredients: commonIngredients,
  ...
  },
  {
    ...
    name: "🔥 Promo: 3 Cajas de Sachets Vitafer-L",
    modelPath: "/images/sachetsx3.png",
    price: "$ 1.900",
    originalPrice: "$ 2.700",
    isPromo: true,
    presentation: "Pack de 3 Cajas de Sobres de 10mL c/u",
    description: "¡El combo perfecto! 3 cajas de potencia portátil con un precio irresistible.",
    detailedDescription: "Disfruta de la libertad y la potencia con este pack de 3 cajas de sachets. Ideal para un fin de semana largo o para tener siempre una reserva a mano. La misma fórmula efectiva en su presentación más práctica, ahora con un descuento especial.",
    ingredients: commonIngredients,
    usageInstructions: "Adultos: Consumir el contenido completo de un sachet (10ml) directamente, 30 a 60 minutos antes de la actividad.",
    benefits: commonBenefits,
