...
const AppShowcase = () => {
  ...
  const cardsData = [
    {
      image: "/images/vitafer-bottle-styled1.png",
    ...
    {
      image: "/images/vitafer-bottle-styled2.png",
  ...
  return (
    <section
        id="vitalidad"
      ref={sectionRef}
      className="bg-gradient-to-b from-black via-red-950/10 to-black text-white py-28 px-6 md:px-16 lg:px-24"
    >
        ...
        {cardsData.map((card, index) => (
          ...
          >
            <img
              src={card.image}
              alt={card.alt}
              className="mx-auto h-64 md:h-72 w-auto object-contain mb-8 drop-shadow-[0_5px_15px_rgba(0,0,0,0.4)]"
            />
