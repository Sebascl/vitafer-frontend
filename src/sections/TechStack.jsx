    ...
    <div className="flex-center section-padding bg-black text-white overflow-hidden py-10">
      <div className="w-full h-full md:px-10 px-5 max-w-7xl mx-auto">
        ...
        <div id="skills" className="mb-16 md:mb-20">
          <TitleHeader title="💣 LIQUIDACIÓN TOTAL 💣" sub="¡NUNCA VISTO! TODO CON 50% DCTO + ENVÍO GRATIS. ¡APOCALIPSIS DE PRECIOS!" />

          <div className="text-center mt-8 mb-12 p-5 bg-gradient-to-br from-red-800 via-black to-red-900 rounded-3xl shadow-2xl shadow-red-500/40 border-4 border-red-600 animate-pulse">
            <p className="text-3xl md:text-5xl font-black text-yellow-300 drop-shadow-lg tracking-wider [text-shadow:_0_4px_8px_rgba(255,0,0,0.8)]">¡50% OFF EN TODO!</p>
            <p className="text-xl md:text-2xl font-extrabold text-white mt-2">Y ADEMÁS...</p>
            <p className="text-2xl md:text-4xl font-bold text-yellow-300 mt-1 drop-shadow-md animate-bounce">🚚 ¡ENVÍO GRATIS! 🚚</p>
            <p className="mt-4 text-sm font-medium text-white/80">¡Aprovecha esta locura antes de que nos arrepintamos! El stock se quema. 🔥</p>
          </div>
